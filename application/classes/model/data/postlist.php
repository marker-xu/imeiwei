...
class Model_Data_Postlist extends Model_Data_MongoCollection {
	
	
	public function __construct() {
		parent::__construct("cloudsearch", "mmshow", "post_list");
	}
	 ...
	 * @param $arrParams
	 */
	public function modifyById($postId, $arrParams, $strFrom=null) {
		JKit::$log->debug(__FUNCTION__." query-{$query}, params-", $arrParams);
